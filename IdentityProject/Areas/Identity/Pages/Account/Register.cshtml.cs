    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToPage("RegisterConfirmation", new { email = Input.Email, returnUrl = returnUrl,code = code });
                    }
                    else
                    {
        ...
        private async Task<bool> SendEmailAsync(string email, string subject, string confirmLink)
        {
            ...
            try
            {
                ...
                //string fromaddr = "tapan.bhatt@eixsys.com";
                //string toaddr = email;//TO ADDRESS HERE
                //string password = "Ehoffice123#";

                //MailMessage msg = new MailMessage();
                //msg.Subject = subject;
                //msg.From = new MailAddress(fromaddr);
                //msg.Body = confirmLink;
